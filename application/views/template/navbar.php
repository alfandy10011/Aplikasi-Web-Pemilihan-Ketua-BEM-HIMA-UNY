<nav class="navbar text-center" style="height: 100px; padding-top: 1%; background-color: #EA2027">
	...
	<div class="col-sm-8 col-lg-4">
		<strong class="hidden-xs" style="color: white; font-size: 24pt"><?php echo NAMA_APP?></strong>
		<strong class="hidden-sm hidden-md hidden-lg hidden-xl" style="color: white; font-size: 18pt"><?php echo NAMA_APP?></strong>
		
		<p style="color: white"><?php echo NAMA_APP_KET?></p>
	</div>
