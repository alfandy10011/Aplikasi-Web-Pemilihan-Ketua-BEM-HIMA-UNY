<footer class="footer" style="background-color: #2f3640; height: 50px; padding-top: 1%">
  <div class="container">
    <div class="col-sm-12">
      <p class="text-muted text-center" style="color:#dcdde1"><img width="20px" alt="Brand" src="<?php echo base_url('asset/img/kpu.png') ?>"> <?php echo NAMA_APP?> <?php echo date('Y')?></p>
    </div>
    <!--<div class="col-sm-6">
